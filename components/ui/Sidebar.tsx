...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  return (
    <>
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-72 border-r border-neutral-800 bg-neutral-950/70 px-6 py-6 shadow-2xl backdrop-blur lg:flex">
        <SidebarContent />
      </aside>
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 w-72 border-r border-neutral-800 bg-neutral-950/95 px-6 py-6 shadow-2xl backdrop-blur transition-transform duration-200 lg:hidden",
