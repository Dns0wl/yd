 ...
 */
export function ManualPaperTemplate({ customerName, purchaseDate, purchaseChannel }: ManualPaperTemplateProps) {
  const formattedDate = formatDate(purchaseDate);

  return (
    <div className="flex w-[525px] items-center justify-center bg-transparent">
      <div
        className="relative h-[742px] w-[525px] overflow-hidden rounded-2xl border border-neutral-300 bg-neutral-100 text-neutral-900 shadow-xl"
        style={{
          backgroundImage:
      ...
      >
        ...
        {/* Middle dark band */}
        <div className="relative mt-10 flex h-64 items-center justify-center bg-neutral-800 px-12 text-center text-neutral-50">
